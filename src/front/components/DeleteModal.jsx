...
function DeleteModal({ show, onClose, onConfirm, loading, title = "Eliminar Curso", message = "¿Confirma que desea eliminar este curso?" }) {
  if (!show) return null;
    ...
    <div className="modal-overlay">
      <div className="skillbank-modal" style={{ maxWidth: '400px' }}>
        ...
        <div className="modal-body text-center py-4">
          ...
          <p className="fs-5 mb-1 fw-semibold text-light">{message}</p>
